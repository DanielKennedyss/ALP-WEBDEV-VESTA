...
<style>
    ...
    /* Hapus styling dari header.blade.php dan base scroll container padding */
    ...
    <div class="form-panel">
        <div style="width: 100%; max-width: 420px;">
            <div style="margin-bottom: 2rem;">
                ...
                <p class="label-caps">Sign in to your account to view your orders and curations.</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST" class="form-minimal">
                ...
                @if (session('error'))
                    <div style="background-color: #f8d7da; border: 1px solid #f5c6cb; color: #721c24; padding: 12px; margin-bottom: 1.5rem; font-size: 13px; text-align: center;">
                        {{ session('error') }}
                    </div>
                @endif
            ...
            <p style="margin-top: 2rem; text-align: center;">
                ...
                <a href="{{ route('register') }}" class="text-dark ms-1" style="text-decoration: underline;">Sign Up Here</a>
            </p>
        </div>
    </div>
</div>
