            ...
            <div class="col-lg-5">
                <div class="form-luxury-card shadow-sm mb-4" style="position: sticky; top: 30px;">
                        ...
                        <div id="collection_preview" class="border overflow-hidden rounded-3 shadow-sm relative mb-4 transition-all duration-300" 
                             style="background-color: {{ $event->theme_color }}; color: {{ $event->text_color }}; border-color: {{ $event->text_color }}44; width: 100%; aspect-ratio: 21/9; max-height: 400px; display: flex; align-items: center; justify-content: space-between; padding: 2rem; background-size: cover; background-position: center; border-radius: 8px; overflow: hidden; font-family: 'Montserrat', sans-serif; background-image: url('{{ $initialBgImage }}');">
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start text-start" style="max-width: 50%; z-index: 10;">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm text-uppercase font-semibold" id="prev-col-btn" style="font-size: 7px; border: 1px solid currentColor; background-color: {{ $event->text_color }}; color: {{ $event->theme_color }}; letter-spacing: 0.1em; padding: 5px 10px; pointer-events: none;">EXPLORE COLLECTION</a>
                            </div>

                            <!-- Right Side (Main Image) -->
                            <img id="preview_main_image" src="{{ $initialMainImage }}" alt="" style="max-width: 50%; max-height: 100%; object-fit: contain; z-index: 10; border-radius: 4px; {{ $initialMainImage ? '' : 'display: none;' }}">
                        </div>
                        ...
                        <div id="home_preview" class="border overflow-hidden rounded-3 shadow-sm relative transition-all duration-300" 
                             style="background-color: #000; color: #fff; min-height: 400px; width: 100%; font-family: 'Montserrat', sans-serif; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; background-size: cover; background-position: center; background-image: url('{{ $initialBgImage }}');">
