            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <div class="color-preview-row">
                        ...
                        <div class="color-preview-box" id="theme_preview"
                             style="background: {{ old('theme_color', $event->theme_color) }};"></div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="color-preview-row">
                        ...
                        <div class="color-preview-box" id="text_preview"
                             style="background: {{ old('text_color', $event->text_color) }};"></div>
                    </div>
                ...
                <div class="col-12">
                    ...
                    <input type="url" name="banner_image" id="banner_image"
                           value="{{ old('banner_image', $event->banner_image) }}"
                ...
                <div class="col-md-6">
                    ...
                    @if($event->background_image)
                        <div class="mb-2 p-2 border rounded d-flex align-items-center gap-3 bg-light">
                            <img src="{{ asset('storage/' . $event->background_image) }}" alt="Background" style="height: 50px; width: 80px; object-fit: cover; border-radius: 4px;">
                    ...
                    <p class="text-muted mt-2 mb-0" style="font-size: 11px;">Upload a new image to replace the current full-width background.</p>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    @if($event->main_image)
                        <div class="mb-2 p-2 border rounded d-flex align-items-center gap-3 bg-light">
                            <img src="{{ asset('storage/' . $event->main_image) }}" alt="Main" style="height: 50px; width: 50px; object-fit: cover; border-radius: 4px;">
                    ...
                    <p class="text-muted mt-2 mb-0" style="font-size: 11px;">Upload a new image to replace the current overlay/product banner.</p>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="display_description" id="display_description" rows="3"
                              ...
                              class="form-control-luxury @error('display_description') is-invalid @enderror">{{ old('display_description', $event->display_description) }}</textarea>
...
function transferSelected(fromPanelId, toPanelId) {
    ...
    fromList.querySelectorAll('.listbox-item.selected').forEach(item => {
        item.classList.remove('selected');
        toList.appendChild(item);
    });
    syncHiddenSelect(); updateCounts();
...
function bindSearch(inputId, listId) {
    document.getElementById(inputId).addEventListener('input', function() {
        ...
        document.querySelectorAll('#' + listId + ' .listbox-item').forEach(item => {
            item.style.display = (item.dataset.name.includes(q) || item.dataset.cat.includes(q)) ? '' : 'none';
        });
    });
}
...
document.getElementById('eventForm').addEventListener('submit', syncHiddenSelect);
