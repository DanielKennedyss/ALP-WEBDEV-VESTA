    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'price' => 3500000,
                'weight' => 1500,
                'image_path' => 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=600&q=80',
                'description' => 'Premium cowhide leather jacket with silver hardware. Timeless style and extreme durability.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 10, 'minimum_stock' => 5],
                    ['size_label' => 'M',  'stock' => 12, 'minimum_stock' => 5],
                    ['size_label' => 'L',  'stock' => 15, 'minimum_stock' => 5],
                    ['size_label' => 'XL', 'stock' => 8,  'minimum_stock' => 3],
                ],
            ],
            [
                ...
                'price' => 1800000,
                'weight' => 400,
                'image_path' => 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=600&q=80',
                'description' => 'Light and breezy floral print dress made of soft organic cotton. Perfect for warm sunny days.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 8,  'minimum_stock' => 3],
                    ['size_label' => 'M',  'stock' => 12, 'minimum_stock' => 3],
                    ['size_label' => 'L',  'stock' => 10, 'minimum_stock' => 3],
                ],
            ],
            [
                ...
                'price' => 1400000,
                'weight' => 700,
                'image_path' => 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=600&q=80',
                'description' => 'Classic indigo slim-fit jeans crafted from premium stretch denim for maximum comfort.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 15, 'minimum_stock' => 5],
                    ['size_label' => 'M',  'stock' => 20, 'minimum_stock' => 5],
                    ['size_label' => 'L',  'stock' => 18, 'minimum_stock' => 5],
                    ['size_label' => 'XL', 'stock' => 12, 'minimum_stock' => 5],
                ],
            ],
            [
                ...
                'price' => 2200000,
                'weight' => 450,
                'image_path' => 'https://images.unsplash.com/photo-1574164904299-3a102b110380?w=600&q=80',
                'description' => 'Ultra-soft 100% cashmere knit sweater. A versatile, warm and cozy layering piece.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 12, 'minimum_stock' => 4],
                    ['size_label' => 'M',  'stock' => 15, 'minimum_stock' => 4],
                    ['size_label' => 'L',  'stock' => 15, 'minimum_stock' => 4],
                    ['size_label' => 'XL', 'stock' => 10, 'minimum_stock' => 4],
                ],
            ],
            [
                ...
                'price' => 1950000,
                'weight' => 50,
                'image_path' => 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&q=80',
                'description' => 'Sleek polarized sunglasses with custom acetate frames. Offers full UV protection.',
                'variants' => [
                    ['size_label' => 'One Size', 'stock' => 30, 'minimum_stock' => 10],
                ],
            ],
            [
                ...
                'weight' => 80,
                'image_path' => 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=600&q=80',
                'description' => 'Exquisite silk scarf featuring a hand-drawn geometric pattern. Adds elegance to any outfit.',
                'variants' => [
                    ['size_label' => 'One Size', 'stock' => 25, 'minimum_stock' => 8],
                ],
            ],
            [
                ...
                'price' => 3800000,
                'weight' => 1000,
                'image_path' => 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=600&q=80',
                'description' => 'Premium calfskin suede bomber jacket. Ribbed cuffs and hem for a contemporary look.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 8,  'minimum_stock' => 3],
                    ['size_label' => 'M',  'stock' => 10, 'minimum_stock' => 3],
                    ['size_label' => 'L',  'stock' => 10, 'minimum_stock' => 3],
                    ['size_label' => 'XL', 'stock' => 6,  'minimum_stock' => 2],
                ],
            ],
            [
                ...
                'price' => 1100000,
                'weight' => 350,
                'image_path' => 'https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=600&q=80',
                'description' => 'High-waisted pleated midi skirt in a lightweight flowy crepe fabric. Elegant and breezy.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 12, 'minimum_stock' => 4],
                    ['size_label' => 'M',  'stock' => 15, 'minimum_stock' => 4],
                    ['size_label' => 'L',  'stock' => 12, 'minimum_stock' => 4],
                ],
            ],
            [
                ...
                'price' => 450000,
                'weight' => 200,
                'image_path' => 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=600&q=80',
                'description' => 'Heavyweight organic cotton classic white tee. The ultimate essential for daily wear.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 40, 'minimum_stock' => 15],
                    ['size_label' => 'M',  'stock' => 50, 'minimum_stock' => 15],
                    ['size_label' => 'L',  'stock' => 45, 'minimum_stock' => 15],
                    ['size_label' => 'XL', 'stock' => 30, 'minimum_stock' => 10],
                ],
            ],
            [
                ...
                'price' => 4200000,
                'weight' => 1300,
                'image_path' => 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=600&q=80',
                'description' => 'Double-breasted wool blend trench coat. Classic silhouette with modern tailoring.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 6,  'minimum_stock' => 2],
                    ['size_label' => 'M',  'stock' => 8,  'minimum_stock' => 2],
                    ['size_label' => 'L',  'stock' => 8,  'minimum_stock' => 2],
                    ['size_label' => 'XL', 'stock' => 4,  'minimum_stock' => 2],
                ],
            ],
            [
                ...
                'weight' => 450,
                'image_path' => 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=600&q=80',
                'description' => 'Flattering chiffon wrap dress with delicate ruffle details and an adjustable waist tie.',
                'variants' => [
                    ['size_label' => 'S',  'stock' => 8,  'minimum_stock' => 3],
                    ['size_label' => 'M',  'stock' => 10, 'minimum_stock' => 3],
                    ['size_label' => 'L',  'stock' => 8,  'minimum_stock' => 3],
            ...
            [
                ...
                'price' => 600000,
                'weight' => 60,
                'image_path' => 'https://images.unsplash.com/photo-1627124765135-565b502b41a5?w=600&q=80',
                'description' => 'Minimalist leather card holder with four card slots and a central compartment.',
                'variants' => [
                    ['size_label' => 'One Size', 'stock' => 35, 'minimum_stock' => 10],
                ],
            ],
        ];
